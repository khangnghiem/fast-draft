...
export const fdcanvas_get_all_notes: (a: number) => [number, number];
export const fdcanvas_get_node_animations_json: (a: number, b: number, c: number) => [number, number];
export const fdcanvas_get_note: (a: number, b: number, c: number) => [number, number];
export const fdcanvas_remove_node_animations: (a: number, b: number, c: number) => number;
export const fdcanvas_set_note: (a: number, b: number, c: number, d: number, e: number) => number;
