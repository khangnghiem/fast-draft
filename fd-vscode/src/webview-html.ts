...
<body>
  <div id="toolbar">
    ...
    <div class="tb-zone tb-right">
      <button class="tool-btn" id="specs-toggle-btn" title="Specs Panel" aria-label="Toggle Specs Panel">📝</button>
      <span class="fs-hide" id="status">Loading WASM…</span>
      <button class="tool-btn" id="fullscreen-toggle-btn" title="Full Screen (⇧F)" aria-label="Toggle Full Screen">⛶</button>
      <!-- Settings Hamburger ☰ -->
      <div class="settings-dropdown-container fs-hide" id="settings-dropdown-container">
      <button class="tool-btn" id="settings-menu-btn" title="Settings & tools" aria-label="Open Settings Menu">☰</button>
  ...
  <div id="canvas-container">
    ...
    <div id="ai-chat-panel" class="ai-chat-panel hidden">
      <div class="ai-chat-header">
        ...
        <div class="ai-chat-header-actions">
          <button class="ai-chat-clear" id="ai-chat-clear" title="Clear chat" aria-label="Clear Chat History">🗑</button>
      ...
      <div class="ai-chat-input-area">
        ...
        <button class="ai-chat-send" id="ai-chat-send" title="Send" aria-label="Send AI Chat Message">→</button>
      </div>
    </div>
    ...
    <div id="minimap-container"><canvas id="minimap-canvas"></canvas><div id="minimap-zoom-controls"><button class="bl-btn" id="zoom-out-btn" title="Zoom out" aria-label="Zoom out minimap">−</button><div class="bl-sep"></div><button class="bl-btn" id="zoom-reset-btn" title="Reset zoom (click)" aria-label="Reset minimap zoom">100%</button><div class="bl-sep"></div><button class="bl-btn" id="zoom-in-btn" title="Zoom in" aria-label="Zoom in minimap">+</button></div></div>
