  ...
  <div id="canvas-container">
    ...
    <div id="floating-toolbar" class="scroll-toolbar horizontal unrolled">
      ...
      <div class="scroll-paper-body">
        <button class="ft-tool-btn active" data-tool="hand"><svg viewBox="0 0 18 18" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><path d="M6.5 7.5V3.5a1 1 0 012 0V7"/><path d="M8.5 4V2a1 1 0 012 0v5"/><path d="M10.5 4.5V3a1 1 0 012 0v4.5"/><path d="M12.5 7V5.5a1 1 0 012 0v4a5 5 0 01-5 5h-1a5 5 0 01-5-5V7a1 1 0 012 0v2"/></svg><span class="ft-tooltip">Hand<span class="tt-shortcut">H</span></span></button>
        <button class="ft-tool-btn" data-tool="select"><svg viewBox="0 0 18 18" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3.5 2L3.5 13.5L7 10L11.5 14.5L13 13L9 8.5L13 8.5Z"/></svg><span class="ft-tooltip">Select<span class="tt-shortcut">V</span></span></button>
