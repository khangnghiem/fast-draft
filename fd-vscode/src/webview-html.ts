...
<body>
  ...
  <div id="canvas-container">
    ...
    <div id="floating-action-bar">
      ...
      <div class="fab-sep"></div>
      <button class="fab-delete-btn" id="deleteSelectedBtn" aria-label="Delete selected" title="Delete (⌫)"><svg width="14" height="14" viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"><line x1="3" y1="3" x2="11" y2="11"/><line x1="11" y1="3" x2="3" y2="11"/></svg></button>
    ...
    <div id="ai-chat-panel" class="ai-chat-panel hidden">
      <div class="ai-chat-header">
        ...
        <div class="ai-chat-header-actions">
          ...
          <button class="ai-chat-close" id="ai-chat-close" aria-label="Close chat" title="Close">✕</button>
        </div>
      </div>
