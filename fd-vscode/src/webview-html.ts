  ...
  <div id="canvas-container">
    ...
    <div id="floating-toolbar" class="scroll-toolbar horizontal unrolled">
      ...
      <div class="scroll-paper-body">
        <button class="ft-tool-btn active" data-tool="hand"><svg viewBox="0 0 18 18" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M9 2v10M5.5 5v7.5a3.5 3.5 0 003.5 3.5h0a3.5 3.5 0 003.5-3.5V5M3.5 7v5.5a5.5 5.5 0 005.5 5.5h0a5.5 5.5 0 005.5-5.5V7"/></svg><span class="ft-tooltip">Hand<span class="tt-shortcut">H</span></span></button>
