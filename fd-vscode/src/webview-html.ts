  ...
  <div id="canvas-container">
    ...
    <div id="floating-toolbar" class="scroll-toolbar horizontal unrolled">
      ...
      <div class="scroll-paper-body">
        <button class="ft-tool-btn active" data-tool="hand"><svg viewBox="0 0 18 18" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9V4.5a1 1 0 012 0V9M8 4V2.5a1 1 0 012 0V9M10 4.5V3.5a1 1 0 012 0V9a4.5 4.5 0 01-9 0V7.5a1 1 0 012 0V9"/></svg><span class="ft-tooltip">Hand<span class="tt-shortcut">H</span></span></button>
        <button class="ft-tool-btn" data-tool="select"><svg viewBox="0 0 18 18" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"><path d="M4 2v12l3.5-3.5L11 16l1.5-1-3.5-5.5H13z"/></svg><span class="ft-tooltip">Select<span class="tt-shortcut">V</span></span></button>
        ...
        <button class="ft-tool-btn" data-tool="pen"><svg viewBox="0 0 18 18" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><path d="M14.5 2.5l1 1-10 10H3v-2.5zM12 5l1 1"/><path d="M3 15.5l1.5-.5-.5-1"/></svg><span class="ft-tooltip">Pen<span class="tt-shortcut">P</span></span></button>
        ...
        <button class="ft-tool-btn" data-tool="eraser"><svg viewBox="0 0 18 18" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><path d="M3.5 11l4.5-4.5 5 5-4.5 4.5H5.5l-2-2z"/><line x1="5" y1="16" x2="15" y2="16"/></svg><span class="ft-tooltip">Eraser<span class="tt-shortcut">E</span></span></button>
      </div>
