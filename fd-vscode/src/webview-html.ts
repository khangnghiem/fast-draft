...
<body>
  <div id="toolbar">
    <div class="tb-zone tb-left fs-hide">
      ...
      <button class="tool-btn" id="ai-chat-btn" title="AI Agent — chat about your design" aria-label="Open AI Agent chat">✦ Agent</button>
      <button class="tool-btn" id="renamify-btn" title="Renamify — batch AI rename anonymous node IDs" aria-label="Batch AI rename nodes">✦ Renamify</button>
    </div>
    ...
    <div class="tb-zone tb-right">
      ...
      <div class="settings-menu" id="settings-menu">
        <button class="settings-menu-item" id="sm-grid-toggle" aria-label="Toggle Grid"><span class="sm-icon">⊞</span><span class="sm-label">Grid</span><span class="sm-shortcut">G</span></button>
        <button class="settings-menu-item" id="sm-note-badge-toggle" aria-label="Toggle Note Badges"><span class="sm-icon">◇</span><span class="sm-label">Note Badges</span></button>
        <button class="settings-menu-item" id="sm-library-toggle" aria-label="Toggle Libraries"><span class="sm-icon">📦</span><span class="sm-label">Libraries</span><span class="sm-shortcut">⇧L</span></button>
        <button class="settings-menu-item" id="sm-sketchy-toggle" aria-label="Toggle Sketchy Mode"><span class="sm-icon">✏️</span><span class="sm-label">Sketchy Mode</span></button>
        <button class="settings-menu-item" id="sm-theme-toggle" aria-label="Toggle Dark Theme"><span class="sm-icon">🌙</span><span class="sm-label">Dark Theme</span></button>
        <div class="settings-menu-sep"></div>
        <button class="settings-menu-item" data-export="png-clip" aria-label="Copy as PNG"><span class="sm-icon">📋</span><span class="sm-label">Copy as PNG</span><span class="sm-shortcut">⌘⇧C</span></button>
        <button class="settings-menu-item" data-export="png-file" aria-label="Save as PNG"><span class="sm-icon">🖼️</span><span class="sm-label">Save as PNG</span></button>
        <button class="settings-menu-item" data-export="svg-file" aria-label="Save as SVG"><span class="sm-icon">✨</span><span class="sm-label">Save as SVG</span></button>
        <button class="settings-menu-item" data-export="fd-clip" aria-label="Copy as .fd"><span class="sm-icon">📝</span><span class="sm-label">Copy as .fd</span></button>
        <div class="settings-menu-sep"></div>
        <button class="settings-menu-item" id="sm-import-css" aria-label="Import CSS"><span class="sm-icon">🎨</span><span class="sm-label">Import CSS</span></button>
        <div class="settings-menu-sep"></div>
        <button class="settings-menu-item" id="sm-shortcuts" aria-label="Keyboard Shortcuts"><span class="sm-icon">⌨️</span><span class="sm-label">Keyboard Shortcuts</span><span class="sm-shortcut">?</span></button>
      </div>
      </div>
    </div>
  </div>
      ...
      <div class="props-inner">
        ...
        <div class="props-section" id="props-actions-section">
          ...
          <div class="props-actions-grid">
            <button class="props-action-btn" id="props-group" title="Group ⌘G" aria-label="Group selected items">◻ Group</button>
            <button class="props-action-btn" id="props-ungroup" title="Ungroup ⇧⌘G" aria-label="Ungroup selected items">◫ Ungroup</button>
            <button class="props-action-btn" id="props-duplicate" title="Duplicate ⌘D" aria-label="Duplicate selected items">⊕ Duplicate</button>
            ...
            <button class="props-action-btn" id="props-copy-png" title="Copy as PNG ⌘⇧C" aria-label="Copy as PNG">🖼 PNG</button>
            <button class="props-action-btn props-delete-btn" id="props-delete" title="Delete ⌫" aria-label="Delete selected">🗑 Delete</button>
          </div>
        </div>
    </div>
  </div>
