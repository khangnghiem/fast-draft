...
<body>
  <div id="toolbar">
    ...
    <div class="tb-zone tb-right">
      <button class="tool-btn" id="notes-toggle-btn" title="Notes Panel" aria-label="Toggle Notes Panel">📝</button>
  ...
  <div id="canvas-container">
    ...
    <div id="notes-panel" class="notes-panel hidden">
      <div class="notes-panel-header">
        ...
        <button class="notes-panel-close" id="notes-panel-close" title="Close" aria-label="Close Notes Panel">✕</button>
      </div>
      ...
      <div class="props-inner">
        ...
        <div class="props-section" id="props-align-section" style="display:none">
          ...
          <div class="align-grid" id="align-grid">
            ...
            <button class="align-cell" data-h="center" data-v="middle" aria-label="Align Center"><span class="align-dot"></span></button>
