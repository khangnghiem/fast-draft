...
| R4.7–R4.11  | `exportSpec.test.ts`, `spec-view.test.ts`                                                                                                                                                                                                                          | ✅ TS tests added              |
