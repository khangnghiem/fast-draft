...
| R4.7–R4.11  | `buildSpecMarkdown`, `FdSpecViewPanel` coverage in `fd-vscode/src/exportSpec.test.ts` and `fd-vscode/src/panels/spec-view.test.ts`                                                                                                                                 | ✅ 2 test files (JS-only)      |
