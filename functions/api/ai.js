...
function getCorsHeaders(request) {
  ...
  const allowedExact = ['https://fast-draft.com', 'http://localhost:3000', 'https://tauri.localhost'];

  let allowedOrigin = null;
  if (allowedExact.includes(origin) || origin.startsWith('vscode-webview://') || origin.startsWith('tauri://')) {
