...
function getCorsHeaders(request) {
  ...
  // If the origin is in our whitelist, allow it. Otherwise default to fast-draft.com.
  const allowedOrigin = ALLOWED_ORIGINS.includes(origin) ? origin : 'https://fast-draft.com';
