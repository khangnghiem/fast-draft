...
function getCorsHeaders(request) {
  ...
  if (origin) {
    if (ALLOWED_ORIGINS.includes(origin) || origin.startsWith('vscode-webview://') || origin.startsWith('tauri://')) {
      allowOrigin = origin;
    }
  }

  return {
    'Access-Control-Allow-Origin': allowOrigin || 'https://fast-draft.com',
